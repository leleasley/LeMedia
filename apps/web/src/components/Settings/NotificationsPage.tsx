      ...
      <div className="rounded-2xl md:rounded-3xl border border-white/10 bg-white/[0.02] p-6 md:p-8">
        <div className="flex items-center gap-4 mb-6">
          ...
          <div className="flex-1">
            ...
            <p className="text-sm text-gray-400 mt-1">Not available on this device</p>
          </div>
  ...
  return (
    <div className="rounded-2xl md:rounded-3xl border border-white/10 bg-white/[0.02] p-6 md:p-8">
      <div className="flex items-center gap-4 mb-6">
        ...
        <div className="flex-1">
          <h3 className="text-xl font-bold text-white">Browser Push</h3>
          <p className="text-sm text-gray-400 mt-1">Desktop and mobile alerts for requests and releases</p>
        </div>
      ...
      <div className="rounded-lg bg-white/5 border border-white/5 p-4">
        <div className="flex items-start gap-3">
          ...
          <div className="text-xs text-gray-400 space-y-1">
            <p>Each device needs to be enabled separately</p>
