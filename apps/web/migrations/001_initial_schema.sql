...
-- Description: Initial database schema for LeMedia
-- Created: 2026-01-15
...
-- Notification endpoints (Discord/Telegram/Email/Webhook configs)
...
-- User notification endpoint subscriptions
...
-- Request items (individual episodes or movies being processed)
...
-- Media issues (quality problems, missing subtitles, etc.)
...
-- Media services (Radarr/Sonarr instances)
...
-- MFA sessions for two-factor authentication setup/verification
