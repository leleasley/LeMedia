        ...
        <div className="relative">
          <div className="flex items-center gap-4">
            <div className="flex items-center justify-center w-14 h-14 rounded-2xl bg-gradient-to-br from-amber-500/20 to-orange-500/20 ring-1 ring-white/10">
              <QueueListIcon className="w-7 h-7 text-amber-300" />
            </div>
            <div>
              <h1 className="text-2xl md:text-3xl font-bold text-white">Jobs & Scheduling</h1>
              <p className="text-sm text-white/60 mt-1">Manage background tasks, schedules, and runtime health metrics.</p>
            </div>
          </div>
        </div>
      </div>
