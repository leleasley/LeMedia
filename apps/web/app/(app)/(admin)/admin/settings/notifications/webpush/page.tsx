...
export const metadata = {
    title: "Web Push Notifications - Admin Settings",
};

export default async function WebPushNotificationsPage() {
    ...
    return <NotificationList type="webpush" typeName="Web Push" />;
}
