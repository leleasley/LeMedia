...
export const metadata = {
    title: "Edit Web Push Notification - Admin Settings",
};

export default async function EditWebPushNotificationPage({
    params,
}: {
    ...
    return <NotificationsWebPush mode="edit" endpointId={parseInt(id)} />;
}
