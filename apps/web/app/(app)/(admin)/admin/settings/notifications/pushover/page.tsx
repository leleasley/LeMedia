...
export const metadata = {
    title: "Pushover Notifications - Admin Settings",
};

export default async function PushoverNotificationsPage() {
    ...
    return <NotificationList type="pushover" typeName="Pushover" />;
}
