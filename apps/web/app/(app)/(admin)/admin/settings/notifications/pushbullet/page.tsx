...
export const metadata = {
    title: "Pushbullet Notifications - Admin Settings",
};

export default async function PushbulletNotificationsPage() {
    ...
    return <NotificationList type="pushbullet" typeName="Pushbullet" />;
}
