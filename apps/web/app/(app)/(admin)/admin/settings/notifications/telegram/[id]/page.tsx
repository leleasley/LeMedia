...
export const metadata = {
    title: "Edit Telegram Notification - Admin Settings",
};

export default async function EditTelegramNotificationPage({
    params,
}: {
    ...
    return <NotificationsTelegram mode="edit" endpointId={parseInt(id)} />;
}
