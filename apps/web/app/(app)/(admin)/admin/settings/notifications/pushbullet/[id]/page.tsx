...
export const metadata = {
    title: "Edit Pushbullet Notification - Admin Settings",
};

export default async function EditPushbulletNotificationPage({
    params,
}: {
    ...
    return <NotificationsPushbullet mode="edit" endpointId={parseInt(id)} />;
}
